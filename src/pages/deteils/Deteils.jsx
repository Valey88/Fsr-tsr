...
export default function Details() {
  const [content, setContent] = useState({
    ...
    "meta-description":
      "Официальные реквизиты ООО «Олимп»: ИНН, КПП, ОГРН, юридический адрес, банковские реквизиты и контактная информация. СФР-ТСР — надёжный поставщик и партнёр.",
    "meta-keywords":
    ...
    "main-heading": "<h1>Реквизиты компании ООО «Олимп»</h1>",
    "section-heading":
      "<h2>ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ «Олимп»</h2>",
    "detail-1":
  ...
  const schemaOrgJSONLD = {
    ...
    description:
      "ООО «Олимп» — надёжный поставщик оборудования и товаров. Работаем по всей России. ИНН 5609200001, КПП 560901002, ОГРН 1225600000456.",
    address: {
      "@type": "PostalAddress",
